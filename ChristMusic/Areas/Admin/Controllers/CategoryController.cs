...
namespace ChristMusic.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Upsert(int? id) //Id is given in case of Edit to know the category to be edited from the id
        {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if(objFromDb == null)
            {
                TempData["Error"] = "Error when deleting Category";
